...
namespace cs6610
{
	namespace Camera
	{
		...
		{
		public:
			Camera(cyPoint3f i_position = cyPoint3f(0.0f), cyPoint3f i_eularAngles = cyPoint3f(0.0f), float i_fieldOfView = Math::ConvertDegreesToRadians(45.0f), float i_nearPlaneDistance = 0.1f, float i_farPlaneDistance = 10000.0f, float i_topPlaneDistance = 20.0f, float i_bottomPlaneDistance = -20.0f, float i_leftPlaneDistance = -40.0f, float i_rightPlaneDistance = 40.0f);
			~Camera();
