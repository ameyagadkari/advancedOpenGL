...
namespace cs6610
{
	namespace Gameplay
	{
		...
		public:
			...
			void LoadMeshAndMaterial(const bool i_isCubeMap, const std::string i_meshRelativePath, const std::vector<std::string> i_shaderPaths, const std::vector<std::string> i_skyBoxTextures, const std::string i_texturePathPrefix = "", const char * const i_names = nullptr);
#pragma region Gets
